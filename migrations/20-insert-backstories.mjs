const backstories = [
  ...
  },
  {
    ...
    last_name_id: 3,
    backstory:
      "Thorynn grew up in the cold coastal waters near Icehaven, not far away from the Fridig Depths. Her mother, Chyronn, is the leader of a group of about 60 aquatic elves, though she reached this position not because of her own abilities. The Fey granted her special gifts - charisma, powerful magic - in exchange for her firstborn. She agreed, and even though she may not have reached her current position because she was the most able - wasn't her dedication and her conviction in reaching it also a form of ability? She seems to think so at least. Thorynn knows this story, or parts of it anyway. Who exactly her father was, and what he had to say about this pact remains unclear, and Chyronn shuts down any mention of him. Thorynn doesn't mind particularly, for she spent part of her childhood in the Feywild, part of it in the icy ocean, and she knows which part she prefers. The Fey court with its beauty, riches and splendour haunts her dreams, yet she can never go there of her own accord, she has to wait for the Fey to fetch her, and they do so less and less. Her last visit was years ago, and she's beginning to wonder if it was all a dream. So if she can't live out her days in the Feywild, she will set out to see what other wonders the rest of the world may hold.",
    verified: true,
  },
  {
    class_id: 10,
